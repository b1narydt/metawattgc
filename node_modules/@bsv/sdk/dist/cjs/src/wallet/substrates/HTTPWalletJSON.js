...
class HTTPWalletJSON {
    constructor(originator, baseUrl = 'http://localhost:3321', httpClient = fetch) {
        ...
        const isBrowser = typeof window !== 'undefined' && typeof document !== 'undefined' && (window === null || window === void 0 ? void 0 : window.origin) !== 'file://';
            ...
            if (!res.ok) {
                if (res.status === 400 && data.isError && data.code === 5) {
                    ...
                    const err = {
                        call,
                        args,
                        message: (_a = data.message) !== null && _a !== void 0 ? _a : `HTTP Client error ${res.status}`
                    };
